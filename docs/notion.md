...
`Previdenciário`, em `Área`, segue a mesma lógica desde 2026-08-28: a
opção fica mantida no Select como legado (páginas das semanas 2026-S34,
S35 e S36 a usam), mas nenhuma execução nova a atribui — a área saiu do
calendário editorial (decisão editorial explícita do usuário, sem
substituição por outra área ou dia) e o banco `temas/previdenciario.md`
foi removido.
...
1. Ler as propriedades de métrica dos posts da semana analisada (7 a
   partir da semana em que Previdenciário saiu do calendário, 2026-08-28;
   8 nas semanas 2026-S35 e 2026-S36; 9 em semanas anteriores — o volume
   mudou com as reorganizações de área, ver `CLAUDE.md`)
