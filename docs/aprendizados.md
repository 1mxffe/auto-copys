# Aprendizados de desempenho

Registro cumulativo de recomendações geradas pelos relatórios semanais de
métricas (`templates/relatorio-semanal.md`, gerado pela skill
`calendario-semanal`, passo 1). Consultado ao escolher formato/área/tema nas
execuções seguintes — ver `docs/formatos.md` e `temas/<area>.md`.
...
> 205/2021 exige. Se uma recomendação de desempenho e uma regra de
> conformidade apontam em direções opostas, a conformidade vence sempre,
> sem exceção. Qualquer entrada abaixo que viole isso deve ser removida, não
> seguida.

## Como uma entrada nasce
...
_Nenhuma ainda — a primeira entrada aparece depois que a Semana 2026-S34
tiver métricas preenchidas no Notion e a skill gerar o primeiro relatório,
aproximadamente na execução da Semana 2026-S36 (2 semanas depois da S34)._

<!--
Formato de cada entrada, a partir daqui:

### Semana AAAA-SNN → aprendizado registrado em AAAA-SNN+2
